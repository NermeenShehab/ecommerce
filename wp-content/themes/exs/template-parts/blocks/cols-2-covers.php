...
<div class="wp-block-columns cols-single-sm gap-30"><!-- wp:column {"className":""} -->
	<div class="wp-block-column">
		<!-- wp:cover {"url":"<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg","id":759,"minHeight":440,"contentPosition":"center center","className":""} -->
		<div class="wp-block-cover has-background-dim" style="min-height:440px"><img
	...
	<!-- wp:column {"className":""} -->
	<div class="wp-block-column">
		<!-- wp:cover {"url":"<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg","id":807,"minHeight":205,"minHeightUnit":"px","className":""} -->
		<div class="wp-block-cover has-background-dim" style="min-height:205px"><img
		...
		<!-- wp:cover {"url":"<?php echo esc_url( EXS_THEME_URI ); ?>/assets/img/cup.jpg","id":827,"minHeight":205,"minHeightUnit":"px","className":""} -->
		<div class="wp-block-cover has-background-dim" style="min-height:205px"><img
